...
/** KarteInAppMessagingPlugin */
public class KarteInAppMessagingPlugin : FlutterPlugin, MethodCallHandler {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "karte_in_app_messaging")
            channel.setMethodCallHandler(KarteInAppMessagingPlugin())
        }
    }
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        ...
        when (className) {
            "InAppMessaging" -> when (methodName) {
                "isPresenting" -> result.success(InAppMessaging.isPresenting)
                "dismiss" -> {
