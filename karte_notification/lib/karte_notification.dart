...
class Notification {
  ...
  static Future<bool> canHandle(Map<String, dynamic> message) async {
    return await _channel.invokeMethod(
        "Notification_canHandle", {"message": message}, false);
  }
  ...
  static Future<Notification> create(Map<String, dynamic> message) async {
  ...
  Future<String> get url async {
    return await _channel.invokeMethod(
        "Notification_url", {'message': message}, null);
  }
  ...
  Future<bool> handleForIOS() async {
    ...
    return await _channel.invokeMethod(
        'Notification_handle', {'message': message}, false);
  }
  ...
  void track() async {
    ...
    await _channel.invokeMethod('Notification_track', {'message': message});
  }
}
